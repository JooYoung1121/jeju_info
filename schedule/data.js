        ...
        places: [
          {
            ...
            desc: "퀸메리호 취항 시: 패밀리침대(4인, 26.8만원) 또는 펫스위트(2인, 25만원). 무게/견종 제한 없음! 미취항 시: 퀸제누비아Ⅱ 펫스위트룸(4인, 전용 화장실). 전용 케이지 지참.",
        ...
        places: [
          {
            name: "제주항",
            address: "제주시 임항로 111",
            desc: "씨월드고속훼리 탑승 (퀸메리호 또는 퀸제누비아Ⅱ). 펫 객실 + 자차 선적.",
            duration: "항해 3시간 30분",
            baby: true,
            dog: true,
          },
...
const CHECKLISTS = {
  ship: {
    ...
    icon: "🚢",
    items: [
      { text: "퀸메리호 예약 확인 (2026.05 취항, 패밀리침대 4인 26.8만원 / 펫스위트 2인 25만원)", checked: false },
      { text: "퀸메리 미취항 시 → 퀸제누비아Ⅱ 펫스위트룸 예약 (4인, 무게 제한 없음, 추가 요금 없음)", checked: false },
      { text: "자차 선적 예약 (국산 승용차 편도 약 9~18만원)", checked: false },
      { text: "왕복 예약 (10/25 출발, 11/23 귀환)", checked: false },
      { text: "퀸메리 취항/예약 오픈 모니터링 (http://qm.seaferry.co.kr/)", checked: false },
...
const FERRY_INFO = {
  ...
  ships: [
    {
      ...
      route: "목포 ↔ 제주 / 진도 ↔ 애월 (예정)",
      schedules: [
        { label: "목포→제주", time: "14:00 출발", duration: "4시간 15분" },
        { label: "제주→목포", time: "07:00 출발", duration: "4시간 15분" },
        { label: "진도→애월 (예정)", time: "02:20 / 11:30", duration: "2시간 40분" },
        { label: "애월→진도 (예정)", time: "07:00 / 16:30", duration: "2시간 40분" },
      ],
      offDays: "매월 1, 3주 토/일 정기휴항",
      highlight: "2026.05 취항 예정 - 국내 최초 PET FIRST CRUISE",
      rooms: [
    ...
    },
    {
      ...
      route: "목포 ↔ 제주",
      schedules: [
        { label: "목포→제주", time: "08:30 출발", duration: "4시간 15분" },
        { label: "제주→목포", time: "16:45 출발", duration: "4시간 30분" },
      ],
  ...
  recommendation: {
    ...
    options: [
      {
        label: "퀸메리 (2026.05 취항 시)",
        ship: "퀸메리호 - PET FIRST CRUISE (무게/견종 제한 없음)",
        room: "패밀리침대 4인 (26.8만원) 또는 펫스위트 2인 (25만원)",
        schedule: "목포발 14:00 → 제주 18:15 도착",
        note: "진도↔애월 노선도 예정! 소요 2시간 40분으로 더 짧음",
      },
      {
        label: "퀸제누비아Ⅱ (현재 운항 중)",
        ship: "퀸제누비아Ⅱ (펫 특화, 무게 제한 없음, 추가 요금 없음)",
        room: "펫스위트룸 (4인, 전용 화장실, 커피쿠폰)",
        schedule: "목포발 08:30 → 제주 12:45 도착 (주간 운항)",
        note: "현재 가장 안정적인 선택. 아기 수면 패턴 유지에 유리.",
      },
    ],
  },
};
...
const BUDGET_GUIDE = {
  ...
  items: [
    ...
    { category: "선박 (왕복)", estimate: "50~80만원", desc: "퀸메리 패밀리침대(26.8만) or 펫스위트(25만) + 자차 선적 왕복" },

...
const SCHEDULE = [
        ...
        places: [
          {
            ...
            desc: "펫스위트룸 이용 (4인, 4kg 이상 가능, 전용 화장실)",
  ...
  },
  {
    ...
    schedule: {
      ...
      afternoon: {
        ...
        places: [
          ...
          {
            name: "세화민속오일시장",
            address: "제주시 구좌읍 세화4길",
            desc: "5, 10, 15, 20, 25, 30일 장날. 로컬 감귤, 해산물, 간식거리.",
            duration: "1시간",
            baby: true,
            dog: false,
          },
    ...
    memo: "장보기 리스트 정리. 오일시장 날짜 확인(26일은 장날일 수도!).",
  ...
  },
  {
        ...
        places: [
          {
            ...
            desc: "UNESCO 세계자연유산. 아기띠로 등반. 강아지 출입 제한 구역 있음.",
            duration: "2시간",
            baby: true,
            dog: false,
          },
    ...
    memo: "성산일출봉은 오전 일찍 갈수록 좋음. 강아지는 번갈아 차에서 대기 or 펫시터.",
  ...
  },
  {
        ...
        places: [
          {
            ...
            desc: "우도행 여객선 탑승. 강아지 동반 가능 여부 사전 확인 필수!",
            duration: "배편 15분",
            baby: true,
            dog: false,
          },
    ...
    memo: "강아지 동반 불가 시 부부 번갈아 우도 방문. 또는 펫시터 이용. 우도 배편 마지막 시간 꼭 확인!",
  ...
  },
  {
        ...
        places: [
          {
            ...
            desc: "세계자연유산 용암동굴. 유모차 진입 가능(포장 구간). 동굴 내 서늘(12~13℃), 겉옷 필수.",
            duration: "1시간 30분",
            baby: true,
            dog: false,
          },
        ...
        places: [
          {
            ...
            desc: "천년 비자나무 숲. 강아지 동반 산책 가능. 유모차보다는 아기띠 추천.",
            duration: "1시간 30분",
            baby: true,
            dog: true,
          },
    ...
    memo: "만장굴 내부 습하고 서늘하므로 아기 겉옷 필수. 비자림은 평탄한 숲길.",
    rainPlan: "만장굴은 실내이므로 비와 무관. 비자림은 우산 쓰고 산책 or 카페로 대체.",
  },
  // === 2주차 (11/1~7) ===
  {
    day: 8,
  ...
  // === 3주차 (11/8~14) ===
  {
        ...
        places: [
          {
            ...
            desc: "용암동굴, 아열대 식물원, 분재원. 유모차 이용 가능.",
            duration: "2시간",
            baby: true,
            dog: false,
          },
    ...
    memo: "동부→서부 이동 약 1시간. 아기 낮잠 시간에 차 이동 추천.",
  ...
  },
  {
    ...
    dayOfWeek: "금",
    theme: "에코랜드",
    categories: ["sightseeing", "baby", "dog"],
    babyFriendly: true,
    dogFriendly: true,
    schedule: {
      morning: {
        ...
        places: [
          {
            ...
            desc: "증기기관차 타고 곶자왈 탐험. 키즈타운, 유모차 이용 가능. 반려견 동반 사전 확인.",
            duration: "3~4시간",
            baby: true,
            dog: true,
          },
    ...
    memo: "에코랜드는 종일 코스. 아기 기관차 탑승 가능. 반려견 동반 규정 사전 확인.",
  ...
  },
  {
        ...
        places: [
          {
            name: "제주 동문야시장",
            address: "제주시 관덕로14길 20",
            desc: "금~일 18:00~23:00 운영. 제주 특산 야시장 먹거리! 아기띠 추천.",
            duration: "2시간",
            baby: true,
            dog: false,
          },
    ...
    memo: "동문야시장은 금~일만 운영! 사람 많으므로 유모차보다 아기띠.",
...
const CHECKLISTS = {
  ship: {
    ...
    icon: "🚢",
    items: [
      { text: "씨월드고속훼리 펫스위트룸 예약 (4인, 4kg 이상 가능, 전용 화장실)", checked: false },

...
// ⚡ 전기차(테슬라 모델Y) 가이드 — 2026년 7월 기준 조사
const EV_GUIDE = {
  title: "⚡ 전기차(테슬라 모델Y) 가이드",
  car: "테슬라 모델Y · 전장 4,750mm / 공차 약 2,000kg (수입차 분류)",
  note: "제주는 전기차·충전기 보급률 전국 1위. 2025.12 '워터' 초급속(200kW)이 동부에도 생겨 이전보다 여유로워졌지만, 기본 전략은 여전히 숙소 완속 야간충전 + 동선 급속입니다.",
  ferryRules: {
  ...
  chargers: {
    ...
    publicNote: "🆕 2025.12 '워터(Water)' 200kW 초급속 10곳 제주 동시 개소 — 동부는 김녕리공영주차장(급속2+완속2)·우도면사무소·동백동산(선흘) 3곳. 김녕이 숙소 최근접 초급속. 기존 김녕 융복합 EV스테이션도 운영 중. 그래도 구좌·성산은 도심보다 드뭄 → 잔량 30% 전 충전소 탐색.",
    adapters: [
    ...
    price: "2026.08부터 출력별 5단계 요금(행정예고): 완속~30kW 294.3원 / 30~50kW 306원 / 50~100kW 324.4원 / 100~200kW 347.2원 / 200kW+ 초급속 391.9원(인상). 슈퍼차저 약 339원/kWh(앱 확인). 여행기간(10~11월)엔 신요금 적용 — 초급속 위주면 한달 약 15~23만원, 완속 위주면 13만원대.",
    mapPoints: [
  ...
  cautions: [
    ...
    "충전요금 5단계 개편은 행정예고(2026.6.30~7.19) 단계 — 8월 시행 예정이나 최종 확정액은 ev.or.kr에서 재확인",
  ],
  sources: [

...
const SCHEDULE = [
  ...
  },
  {
    ...
    memo: "✅ 만장굴 2026.05.30 재개방(입장료 어른 4,000원, 관람 09:00~18:00 · 매표마감 17:00). 유아차 이용 가능하나 입구 계단 구간은 아기띠가 편함. ⚠️ 비자림 반려견 입장 불가(천연기념물) → 한 명이 강아지와 주차장/입구 근처 산책, 번갈아 관람.",
...
const CHECKLISTS = {
  ...
  baby: {
    ...
    items: [
      ...
      { text: "똑닥(ddocdoc) 앱 설치 — 제주 소아과 실시간 접수용", checked: false },
      { text: "아기수첩(예방접종 기록) 챙기기 — 병원 방문 대비", checked: false },
  ...
  dog: {
    ...
    items: [
      ...
      { text: "진드기 예방약(이속사졸린 계열) 출발 전 투여 — 제주 진드기 9~11월 활발", checked: false },
      { text: "심장사상충 예방약 출발 전 투여", checked: false },
    ],
  },
  ev: {
    title: "전기차 (테슬라 모델Y)",
...
const EMERGENCY_CONTACTS = [
  { name: "소아 야간(달빛)", place: "나우메디의원 (매일 ~22시)", phone: "064-727-1339", icon: "👶", mapQuery: "나우메디의원 제주" },
  { name: "소아 응급", place: "제주대병원 응급센터 (24시)", phone: "064-717-1903", icon: "🏥", mapQuery: "제주대학교병원" },
  { name: "동물병원 24시", place: "제주24시숨동물의료센터", phone: "064-805-8365", icon: "🐾", mapQuery: "제주24시숨동물의료센터" },
  { name: "대학병원", place: "제주대학교병원 (대표)", phone: "064-717-1114", icon: "🏨", mapQuery: "제주대학교병원" },
  ...
  { name: "심야약국", place: "세화약국 (구좌, 공공심야)", phone: "064-784-8442", icon: "💊", mapQuery: "세화약국 구좌" },
];

// 🏥 병원·응급 가이드 (영유아 + 반려견) — 2026.07 조사
const MEDICAL_GUIDE = {
  title: "🏥 병원·응급 가이드",
  note: "10~11개월 아기 + 강아지 2마리 기준. 핵심: 동부(구좌·성산)엔 소아과·동물병원이 사실상 없어 야간·응급은 제주시내(차 45~55분)로 가야 합니다. 소요시간은 세화 숙소 기준 추정치, 진료시간은 자주 바뀌니 방문 전 전화 확인!",
  updated: "2026.07",
  hotlines: [
    { icon: "🚑", name: "응급·구급 (달빛병원 안내도)", label: "119", tel: "119" },
    { icon: "👶", name: "제주대병원 응급센터 (소아응급)", label: "064-717-1903", tel: "064-717-1903" },
    { icon: "🐾", name: "24시 동물병원 (숨)", label: "064-805-8365", tel: "064-805-8365" },
    { icon: "🌙", name: "달빛어린이병원 실시간 조회", label: "e-gen ↗", url: "https://www.e-gen.or.kr/moonlight/main.do" },
  ],
  baby: {
    title: "👶 영유아 (10~11개월) 진료",
    wrapBg: "bg-pink-50/60 border-pink-100",
    tips: [
      "제주 소아과 대부분 <b>똑닥(ddocdoc) 앱</b>으로 실시간 접수 — 오픈 시간 맞춰 앱 접수하면 대기 최소화",
      "야간(~22/23시)엔 달빛어린이병원(나우메디가 동부에서 접근성 최선), 그 이후·중증은 제주대병원 응급센터(소아 전용구역 운영)로 직행",
      "동부에서 시내까지 45~55분 걸리니, 아기 컨디션이 이상하면 초저녁에 미리 움직이는 게 안전",
      "낮 경증(감기·가벼운 장염)은 세화 서울의원에서 1차 진료 가능 (소아청소년과 표방 동네의원)",
    ],
    groups: [
      {
        key: "east", name: "동부 · 숙소권 (낮 경증)", color: "green",
        places: [
          { name: "서울의원", type: "내과·소아청소년과 등", address: "제주시 구좌읍 구좌로 51 (세화리)", phone: null, hours: "평일 08:30~17:30 / 토 08:30~12:30 / 일 휴진", dist: "차 5분", lat: 33.5232, lng: 126.8570, note: "숙소에서 가장 가까운 소아 진료 의원. ⚠️ 전화·운영 정보가 오래됐을 수 있어 방문 전 네이버지도로 확인 필수.", mapQuery: "서울의원 구좌 세화" },
          { name: "세화약국", type: "공공심야약국", address: "제주시 구좌읍 세화10길 1", phone: "064-784-8442", hours: "월·금 08:00~19:00 / 화~목 ~23:00 / 토 ~15:00 / 일 휴무", dist: "차 5분", lat: 33.5250, lng: 126.8620, note: "동부 유일 공공심야약국(심야 20:00~23:00 운영일 확인). 해열제·상비약 확보 거점.", mapQuery: "세화약국 구좌" },
        ],
      },
      {
        key: "moonlight", name: "달빛어린이병원 (야간·휴일 소아, ~18세)", color: "violet",
        places: [
          { name: "나우메디의원", type: "달빛 · 소아+응급의학", address: "제주시 연북로 511 에이플렉스 3층 (아라일동)", phone: "064-727-1339", hours: "매일 09:00~22:00 (휴게 12:30~14:00, 18:00~19:00)", dist: "차 45~55분", lat: 33.4843, lng: 126.5346, note: "동부에서 가장 가까운 달빛어린이병원. 소청과+응급의학과 전문의 상주 → 밤 시간대 1순위.", mapQuery: "나우메디의원 제주" },
          { name: "연동365일의원", type: "달빛 · 연중무휴", address: "제주시 연북로 99, 2층 (연동)", phone: "064-727-3651", hours: "평일 09:00~23:00 / 토·일·공휴일 09:00~24:00 (점심 13:00~14:00)", dist: "차 55~65분", lat: 33.4821, lng: 126.4920, note: "밤 11~12시까지 하는 연중무휴 의원. 주말·공휴일 늦은 밤 대안.", mapQuery: "연동365일의원" },
          { name: "탑동365일의원", type: "달빛", address: "제주시 탑동로 24, 2층 (삼도이동)", phone: "064-756-3650", hours: "평일 18:00~23:00 / 토·일·공휴일 09:00~23:00", dist: "차 55~65분", lat: 33.5176, lng: 126.5225, note: "평일은 저녁 진료 전담형.", mapQuery: "탑동365일의원" },
          { name: "우리들소아과의원", type: "달빛 (서귀포)", address: "서귀포시 중정로 70 (서귀동)", phone: "064-732-2323", hours: "평일 18:00~23:00 / 토 10:00~21:00 / 일·공휴일 휴진", dist: "차 ~60분", lat: 33.2479, lng: 126.5638, note: "남부 일정 중 아플 때. 일·공휴일은 휴진 주의.", mapQuery: "우리들소아과 서귀포" },
        ],
      },
      {
        key: "cityclinic", name: "제주시내 소아청소년과 (주간)", color: "pink",
        places: [
          { name: "튼튼소아청소년과의원", type: "소아청소년과", address: "제주시 노형로 376, 2층 (노형동)", phone: "064-748-8275", hours: "평일 08:30~18:30 / 토 09:00~12:30", dist: "차 60분", lat: 33.4668, lng: 126.4573, note: "제주시내 일반 소아과. 똑닥 접수 확인.", mapQuery: "튼튼소아청소년과 제주" },
          { name: "아라의원", type: "소아청소년과 포함", address: "제주시 중앙로 568, 4층 (아라일동)", phone: "064-712-1169", hours: "확인 필요", dist: "차 45~55분", lat: 33.4720, lng: 126.5460, note: "동부→시내 진입로(아라동) 쪽. ⚠️ 시간 미확인 — 전화 후 방문.", mapQuery: "아라의원 제주" },
        ],
      },
      {
        key: "er", name: "응급실 (소아 응급)", color: "red",
        places: [
          { name: "제주대학교병원", type: "권역응급센터 · 소아응급 전용구역", address: "제주시 아란13길 15 (아라일동)", phone: "064-717-1903", hours: "24시간 (대표 064-717-1114)", dist: "차 45~55분", lat: 33.4669, lng: 126.5454, note: "만 18세 이하 소아응급 전용구역 운영 — 아기 야간·중증 시 최우선. 동부에서 종합병원 중 가장 가까움.", mapQuery: "제주대학교병원 응급실" },
          { name: "제주한라병원", type: "권역응급센터 · 권역외상센터", address: "제주시 도령로 65 (연동)", phone: "064-750-9846", hours: "24시간 (대표 064-740-5000)", dist: "차 55~65분", lat: 33.4902, lng: 126.4850, note: "신제주(연동) 쪽 대안. 소아청소년과 운영.", mapQuery: "제주한라병원 응급실" },
          { name: "서귀포의료원", type: "지역응급의료기관", address: "서귀포시 장수로 47 (동홍동)", phone: "064-730-3001", hours: "24시간 (대표 064-730-3100)", dist: "차 ~60분", lat: 33.2555, lng: 126.5638, note: "남부 일정 중 응급 시 (소아 전용구역은 미확인).", mapQuery: "서귀포의료원 응급실" },
        ],
      },
    ],
  },
  pet: {
    title: "🐾 동물병원 (강아지 2마리)",
    wrapBg: "bg-amber-50/60 border-amber-100",
    tips: [
      "행동요령: 주간·경증 = 성산 동아동물병원(25~30분) → 야간·중증(호흡곤란·지속 경련·다량 출혈) = 제주시내 숨/브이 24시(45~55분). 출발 전 반드시 전화로 상태 전달",
      "진드기는 9~11월에도 활발(여행 기간 내내 해당) — 출발 전 이속사졸린 계열 예방약 + 산책 후 귀 뒤·겨드랑이·발가락 사이 점검, 붙었으면 병원에서 제거",
      "해변에서 해수 다량 섭취 시 염분중독(구토·경련), 모래 섭취는 위장폐색 위험 — 담수 챙기고 놀이 후 입·발 헹구기",
      "차에 이동장·물·병원 연락처 상비, 심장사상충 예방약도 출발 전 투여",
    ],
    groups: [
      {
        key: "pet24", name: "24시 응급 (제주시내)", color: "red",
        places: [
          { name: "제주24시숨동물의료센터", type: "365일 24시간", address: "제주시 연북로 632, 1~3층", phone: "064-805-8365", hours: "주간 10:00~21:00 / 야간·응급 21:00~익일 10:00 수의사 상주", dist: "차 45~50분", lat: 33.4899, lng: 126.5457, note: "2025.3 개원, ICU·대학병원급 장비. 야간 응급 1순위. (2026.07 운영 확인)", mapQuery: "제주24시숨동물의료센터" },
          { name: "브이동물메디컬센터", type: "365일 24시간", address: "제주시 수목원서길 3 (한라수목원 인근)", phone: "064-803-0038", hours: "24시간, 야간 응급·입원 케어", dist: "차 45~55분", lat: 33.4674, lng: 126.4930, note: "24시 중환자·응급의료센터. 숨과 함께 야간 응급 투톱. (2026.07 운영 확인)", mapQuery: "브이동물메디컬센터 제주" },
        ],
      },
      {
        key: "peteast", name: "동부 · 주간 1차 대응", color: "amber",
        places: [
          { name: "동아동물병원", type: "동부 최근접", address: "서귀포시 성산읍 서성일로 1241", phone: "064-782-1175", hours: "확인 필요 (방문 전 전화)", dist: "차 25~30분", lat: 33.4380, lng: 126.9010, note: "동부(구좌~성산)에서 확인된 유일한 동물병원. 주간 경증 1차 대응용. ⚠️ 영업 여부 방문 전 재확인.", mapQuery: "동아동물병원 성산" },
        ],
      },
      {
        key: "petother", name: "제주시·서귀포 일반", color: "blue",
        places: [
          { name: "아라i동물병원", type: "제주시", address: "제주시 아라일동 6114-14", phone: null, hours: "화 휴무, 점심 12:50~13:50", dist: "차 45분", lat: 33.4665, lng: 126.5470, note: "동부→시내 진입로 쪽. ⚠️ 전화 미확인 — 네이버지도로 확인 후 방문.", mapQuery: "아라i동물병원 제주" },
          { name: "조은동물병원", type: "서귀포", address: "서귀포시 서귀동 270-7", phone: null, hours: "일 휴무, 점심 12:00~13:30", dist: "차 60분+", lat: 33.2530, lng: 126.5620, note: "남부 일정 중 이용. ⚠️ 전화 미확인 — 네이버지도로 확인 후 방문.", mapQuery: "조은동물병원 서귀포" },
        ],
      },
    ],
  },
  sources: [
    { label: "응급의료포털 e-gen — 달빛어린이병원 실시간", url: "https://www.e-gen.or.kr/moonlight/main.do" },
    { label: "제주도 달빛어린이병원 4곳 지정 (제주도민일보, 2025)", url: "https://www.jejudomin.co.kr/news/articleView.html?idxno=308481" },
    { label: "제주대학교병원 응급의료센터 (소아응급 구역)", url: "https://www.jejunuh.co.kr/treatment/jiryu/er/" },
    { label: "제주도 공공심야약국 안내", url: "https://www.jeju.go.kr/wel/healthCare/healthCareInfo/nightPharmacy.htm" },
    { label: "휴일지킴이약국 (문 여는 약국 실시간)", url: "https://www.pharm114.or.kr/" },
    { label: "제주24시숨동물의료센터 (공식)", url: "https://jejusamc.com/" },
    { label: "브이동물메디컬센터 (공식)", url: "http://vamc.co.kr/" },
    { label: "국가동물보호정보시스템 — 동물병원 검색", url: "https://www.animal.go.kr/front/awtis/shop/hospitalList.do?menuNo=6000000002" },
    { label: "똑닥 — 소아과 실시간 접수 앱", url: "https://www.ddocdoc.com/" },
  ],
};
...
const PET_BABY_SPOTS = {
  ...
  note: "10개월 아기(유모차/아기의자) + 강아지 2마리(4~10kg) 동반 가능한 곳 위주. 노키즈존 제외. 방문 전 전화 확인 권장. ※2026.3.1부터 반려동물 동반 음식점이 법제화(업주 자율 허용제)되면서 '노펫존'을 새로 선언하는 업소도 생기는 중 — 방문 전 확인이 더 중요해졌어요.",
  regions: [
    {
      name: "동부 (성산/구좌)",
      icon: "🏖️",
...
const FERRY_INFO = {
  ...
  ships: [
    {
      ...
      route: "목포 ↔ 제주 (운항 중) / 진도 ↔ 애월 (2026 상반기 취항 계획 발표됐으나 7월 현재 미개통 — 10월에 재확인)",
      schedules: [
  ...
  booking: {
    ...
    pattern: "⚡ 전기차 선적 핵심: 씨월드고속훼리는 배터리 충전율 50% 초과 차량은 선적 거부. 모델Y(수입차 분류) 선적료 편도 약 17.6만원(평일)/18.5만원(일·공휴일) + 2026년 하역비 3% 인상 → 편도 약 18.1만/19.1만 예상 (예약 시 확정).",
    steps: [
...
const BUDGET_GUIDE = {
  ...
  items: [
    ...
    { category: "⚡ 전기차 충전", estimate: "13~23만원", desc: "모델Y 한달 ~1,500km. 완속 294~324원/급속 324~392원/kWh (2026.08 개편 요금, 주유보다 저렴)" },
...
// ⚡ 전기차(테슬라 모델Y) 가이드
// 고정 목록은 여행 동선용 '핵심 거점'이다. 전체 충전기의 가동 상태·요금·커넥터는
// 수시로 바뀌므로, 제주 전체 탐색은 liveMaps의 공식/실시간 지도를 기준으로 한다.
const EV_GUIDE = {
  title: "⚡ 전기차(테슬라 모델Y) 가이드",
  car: "테슬라 모델Y · 전장 4,750mm / 공차 약 2,000kg (수입차 분류)",
  updatedAt: "2026-08-07",
  note: "고정 핀은 숙소·일정에서 쓰기 좋은 핵심 거점입니다. 제주 전체 충전소와 실시간 사용 가능 여부는 아래 실시간 지도를 열어 확인하세요. 가장 안전한 기본 전략은 숙소 완속 야간충전 + 관광 동선 급속입니다.",
  ferryRules: {
    title: "🚢 페리 선적 규정 (가장 중요!)",
    items: [
      { label: "배터리 충전율", value: "선적 전 50% 미만 필수 — 씨월드고속훼리는 50% 초과 시 선적 거부 (해수부 2024.7.9 안전대책, 2026.07 유지 확인). 테슬라 앱 충전한도 50% 설정." },
      { label: "항해 중 충전", value: "완전 금지. 차량 갑판 출입·차내 탑승도 불가 → 필요한 짐은 미리 객실로." },
      { label: "선적료", value: "모델Y는 수입차 분류, 편도 약 175,820원(평일)/185,170원(일·공휴일) 기준에 2026년 하역비 3% 인상 반영 → 편도 약 18.1만/19.1만 예상. ※실제 요금은 예약 시 확정, 1577-3567 재확인." },
      { label: "도착 시간", value: "출항 1시간 30분 전 도착 권장 (차량 선적 마감은 출항 40~60분 전). 전기차 간 70cm 안전거리로 성수기 공간 빨리 소진." },
      { label: "차량 조건", value: "사고 이력·외관 손상(충돌 흔적) 전기차는 선적 거부될 수 있음. 차량등록증 지참." },
    ],
  },
  chargers: {
    title: "🔌 제주 충전 인프라",
    liveMaps: [
      { name: "탐라는 전기차", badge: "제주 전용", note: "제주 전역 충전소·상태를 먼저 확인", url: "https://www.tamraev.com/electronicList" },
      { name: "Tesla Find Us", badge: "테슬라 공식", note: "슈퍼차저·데스티네이션 차저·이용 가능 여부", url: "https://www.tesla.com/ko_KR/findus" },
      { name: "무공해차 통합누리집", badge: "환경부", note: "공공 충전소·커넥터·요금 확인", url: "https://ev.or.kr/" },
      { name: "EV Infra", badge: "실시간", note: "운영 상태·최근 제보·통합결제 확인", url: "https://www.evinfra.co.kr/" },
    ],
    routePlan: [
      { region: "동부 · 숙소권", name: "김녕·구좌·성산", rule: "출발 30% 이상이면 김녕 또는 성산권에서 먼저 보충", color: "ocean" },
      { region: "제주시권", name: "제주 슈퍼차저", rule: "공항·시내 일정과 겹칠 때 10~80% 충전", color: "jeju" },
      { region: "서부 · 남부", name: "애월·한림·중문", rule: "서부 종일 코스 전 60% 이상, 중문은 서귀포 슈퍼차저를 백업", color: "gold" },
    ],
    superchargers: [
      { name: "제주 테슬라 슈퍼차저", address: "제주시 연삼로 136 (오라삼동)", note: "동부 숙소에서 약 30~40km (2026.07 기준 제주 슈퍼차저는 여전히 2곳)" },
      { name: "서귀포 슈퍼차저", address: "서귀포시 중문관광로72번길 35 (롯데호텔제주)", note: "중문관광단지, 주차비 별도" },
    ],
    destination: [
      { name: "사니다카페 (구좌 하도리 907)", note: "데스티네이션 16kW 2기, 연중무휴 (고객 전용, 사전 전화 064-784-8216)" },
      { name: "성산읍 2곳", note: "한도로 269-37(고객전용 064-783-8366)·난산리 2682 (이용 전 사전 연락 권장)" },
    ],
    publicNote: "공공 충전기는 사업자·고장·점검·주차 운영시간에 따라 사용 가능 여부가 달라집니다. 지도 핀은 동선 계획용이며 출발 직전에는 반드시 '제주 전용' 또는 환경부 지도에서 상태와 커넥터를 확인하세요.",
    adapters: [
      "CCS 콤보1 어댑터 (공공 급속 DC콤보 필수 — 워터·환경부 급속 모두 CCS. 테슬라샵 약 30만원 · 모델3/Y 전용)",
    ...
    price: "요금은 사업자·회원 여부·출력·시간대에 따라 변동됩니다. 고정 단가로 예산을 확정하지 말고, 출발 직전 앱/충전기 화면의 kWh당 금액을 확인하세요.",
    mapPoints: [
      { name: "제주 테슬라 슈퍼차저", type: "supercharger", lat: 33.5120, lng: 126.5767, mapQuery: "제주 테슬라 슈퍼차저 연삼로" },
      { name: "서귀포 슈퍼차저 (롯데호텔)", type: "supercharger", lat: 33.2484, lng: 126.4107, mapQuery: "롯데호텔제주 테슬라 슈퍼차저" },
      { name: "데스티네이션 사니다카페(하도리)", type: "destination", lat: 33.5188, lng: 126.8831, mapQuery: "사니다카페 하도리" },
      { name: "데스티네이션 성산(한도로)", type: "destination", lat: 33.4689, lng: 126.9357, mapQuery: "테슬라 데스티네이션 성산 한도로" },
      { name: "데스티네이션 성산(난산리)", type: "destination", lat: 33.4047, lng: 126.8612, mapQuery: "테슬라 데스티네이션 난산리" },
      { name: "김녕 EV충전스테이션", type: "fast", lat: 33.5398, lng: 126.7272, mapQuery: "김녕 융복합 EV충전스테이션" },
      { name: "🆕 워터 김녕리공영주차장 (200kW)", type: "fast", lat: 33.5565, lng: 126.7580, mapQuery: "김녕리공영주차장" },
      { name: "🆕 워터 동백동산 선흘 (200kW)", type: "fast", lat: 33.5120, lng: 126.7120, mapQuery: "동백동산습지센터" },
      { name: "🆕 워터 우도면사무소 (200kW)", type: "fast", lat: 33.5035, lng: 126.9515, mapQuery: "우도면사무소" },
    ],
  },
  tips: [
    "숙소 완속(7kW) 충전 여부를 호스트에 미리 확인 — 야간 충전으로 매일 아침 완충 출발이 최선 (신요금에서 완속이 294~324원으로 더 저렴해짐)",
    "급하게 채울 땐 워터 김녕리공영주차장 200kW(숙소서 ~15분) — 단, 초급속은 391.9원/kWh로 비쌈. 커넥터만 꽂으면 바로 충전('3초 충전'), CCS 어댑터 필수",
    ...
    "전날 밤 다음 날 경로의 충전소를 EV Infra/탐라는전기차로 미리 확인하고, 1순위·2순위 충전소를 각각 저장",
  ],
  cautions: [
    ...
    "충전기 정보와 요금은 수시 변경 — 도착 전 앱에서 운영 상태, 주차 가능 시간, CCS 콤보1 여부를 다시 확인",
  ],
  sources: [
    { label: "충전요금 5단계 개편 행정예고 (이투데이, 2026.07)", url: "https://www.etoday.co.kr/news/view/2580027" },
    { label: "워터 초급속 충전소 제주 10곳 개소 (ZDNet, 2025.12)", url: "https://zdnet.co.kr/view/?no=20251202161517" },
    { label: "테슬라 데스티네이션 차징 (공식)", url: "https://www.tesla.com/ko_KR/findus/list/chargers/South+Korea" },
    ...
    { label: "씨월드고속훼리 요금정보 (2026 하역비 3% 인상)", url: "https://www.seaferry.co.kr/bbs/content.php?co_id=p101" },
    { label: "무공해차 통합누리집 충전요금", url: "https://ev.or.kr/nportal/evcarInfo/initEvcarChargePrice.do" },
  ],
};

// 장소명 → [위도, 경도] 룩업 (지도 마커용). 2026.06 지오코딩(visitjeju·Nominatim 등, 일부 추정).
// 항목에 lat/lng가 직접 있으면 그게 우선(NEARBY_PLACES). 여기는 카페·맛집 / 더 가볼 곳 용.
const SPOT_COORDS = {
  // 카페·맛집 (PET_BABY_SPOTS)
  "어니스트밀크": [33.4504, 126.8720],
  "제주오누이": [33.5426, 126.8281],
  "명리동식당 구좌직영점": [33.5274, 126.8434],
  "평대스낵": [33.5292, 126.8383],
  "성산마씸": [33.4661, 126.9351],
  "쉐프1192레스토랑": [33.3944, 126.9062],
  "세모": [33.5491, 126.8145],
  "애월더선셋": [33.4560, 126.3089],
  "카페 사분의 이": [33.3510, 126.1846],
  "제주개생활연구소": [33.3279, 126.2696],
  "카페비글": [33.5265, 126.6179],
  "금돈가": [33.4843, 126.3915],
  "오데뜨": [33.3687, 126.2850],
  "별돈별 협재해변점": [33.3989, 126.2454],
  "감따남": [33.2641, 126.4941],
  "벨진밧": [33.2519, 126.2747],
  "목장카페 밭디": [33.4077, 126.7729],
  "모메든식당": [33.2534, 126.4547],
  "커뮤니테이블": [33.2448, 126.4593],
  "아솥 서귀포본점": [33.2500, 126.5600],
  "산방산해물라면오빠네": [33.2351, 126.3137],
  "동진식당 공항점": [33.5097, 126.5093],
  // 더 가볼 곳 (EXPLORE_SPOTS)
  "다코네": [33.5292, 126.8383],
  "카페씨닉": [33.5501, 126.7956],
  "플레이스응물": [33.5290, 126.9118],
  "어반정글 성산": [33.4681, 126.9195],
  "제이아일랜드": [33.4660, 126.9220],
  "레이오버": [33.5459, 126.7848],
  "카페 3535.1": [33.5463, 126.6695],
  "블리스풀": [33.4522, 126.3728],
  "모닥식탁": [33.5218, 126.8103],
  "만월당": [33.5502, 126.7960],
  "리로 제주": [33.5283, 126.9125],
  "금백조로가든": [33.4531, 126.8820],
  "주점부리 신양본점": [33.4431, 126.9166],
  "종달 바베큐": [33.5275, 126.9132],
  "나무식탁": [33.2600, 126.2730],
  "지미봉 둘레길": [33.5270, 126.9180],
  "용눈이오름": [33.5055, 126.8200],
  "다랑쉬오름": [33.4977, 126.8007],
  "종달리 해안도로": [33.5275, 126.9150],
  "함도그비치(함덕)": [33.5458, 126.6685],
  "메이즈랜드": [33.5116, 126.8111],
  "신창풍차해안도로": [33.3393, 126.1456],
  "산양큰엉곶": [33.3461, 126.1622],
  "해양동물박물관": [33.4618, 126.9040],
  "일출랜드": [33.4442, 126.9016],
  "넥슨뮤지엄": [33.4867, 126.5015],
  "테디베어뮤지엄 제주": [33.2539, 126.4121],
  "제주민속자연사박물관": [33.5116, 126.5221],
  "비체올린": [33.3380, 126.1820],
  "9.81파크": [33.4630, 126.3570],
  "제주 화조원": [33.4611, 126.3547],
};

// 더 가볼 곳 (후보 풀) — 2026.06 검증, 출처: 비짓제주/제주관광공사 등
const EXPLORE_SPOTS = {
  title: "🧭 더 가볼 곳 (후보 풀)",
  note: "30일 일정과 별개로, 같은 기준(🐶강아지·👶아기 동반 가능)으로 검증한 추가 후보들. 동부 우선. 소규모 업장은 방문 전 영업 확인 권장. ⭐리뷰/🗺️지도로 바로 확인하세요.",
  categories: [
    {
      key: "cafe", name: "반려견 카페·맛집", icon: "🐶☕", color: "amber",
      spots: [
        { name: "다코네", region: "동부·평대", address: "구좌읍 평대4길 20-1", dog: "동반 가능(야외 위주)", baby: "노키즈존 아님", hours: "화~일 10:00~19:00 (월 휴무)", desc: "구좌 평대리 베이커리 카페, 동부 대표 애견카페.", mapQuery: "다코네 평대" },
        { name: "카페씨닉", region: "동부·월정리", address: "구좌읍 월정리 670-5", dog: "동반 가능, 펫 전용 간식·펫밀크", baby: "노키즈존 아님", hours: "10:00~19:00 (휴무 확인)", desc: "월정리 오션뷰 카페, 구좌당근 휘낭시에. 반려견 메뉴 있음.", mapQuery: "카페씨닉 월정리" },
        { name: "플레이스응물", region: "동부·종달리", address: "구좌읍 종달리 756", dog: "동반 가능, 실내외 넓음", baby: "노키즈존 아님", hours: "10:00~22:00 (목 휴무)", desc: "종달리 용천수 옆 카페. 종달 해안도로 산책과 연계 최적.", mapQuery: "플레이스응물 종달리" },
        { name: "어반정글 성산", region: "동부·성산", address: "성산읍 환해장성로 69", dog: "마당+실내외 동반 가능", baby: "노키즈존 아님", hours: "11:00~18:00 (화 휴무)", desc: "성산 마당 있는 애견카페, 수제 간식·디저트.", mapQuery: "어반정글 성산" },
        { name: "제이아일랜드", region: "동부·성산", address: "성산읍 (오션뷰)", dog: "대형견 포함 전 견종 실내 OK", baby: "노키즈존 아님", hours: "방문 전 확인", desc: "성산 통창 오션뷰 대형 펫카페. 모든 실내석 반려견 가능.", mapQuery: "제이아일랜드 성산 카페" },
        { name: "레이오버", region: "동부·구좌", address: "구좌읍 해맞이해안로 648", dog: "동반 가능(야외 테라스)", baby: "노키즈존 아님", hours: "10:30~18:30 (휴무 확인)", desc: "구좌 해안가 대형 오션뷰 카페.", mapQuery: "레이오버 구좌 카페" },
        { name: "카페 3535.1", region: "동부·함덕", address: "조천읍 함덕2길 82", dog: "동반 가능(목줄), 입장료 없음", baby: "노키즈존 아님", hours: "10:00~18:00 (수 휴무)", desc: "함덕 서우봉 인근 정원형 카페. 정원 산책 가능.", mapQuery: "카페 3535.1 함덕" },
        { name: "블리스풀", region: "서부·애월", address: "애월읍 산록서로 383", dog: "15kg↓ 실내, 대형견 야외 운동장(대·중·소 분리)", baby: "노키즈존 아님", hours: "평일 14:00~21:00 / 주말 10:00~20:00 (월 휴무)", desc: "유명 애견 운동장 카페. 수제 반려견 간식.", mapQuery: "블리스풀 애월" },
        { name: "모닥식탁", region: "동부·구좌", address: "구좌읍 한동로 136", dog: "동반 가능(케이지/가방 필수)", baby: "노키즈존 아님", hours: "10:00~15:00 (일·월 휴무)", desc: "수요미식회 출신 구좌 카레 맛집.", mapQuery: "모닥식탁 구좌" },
        { name: "리로 제주", region: "동부·종달리", address: "구좌읍 종달로 60-12", dog: "동반 가능(점주가 반려견 우호적)", baby: "노키즈존 아님", hours: "09:00~15:00 (월·화 휴무)", desc: "종달리 프렌치 브런치. 반려견 간식 챙겨줌.", mapQuery: "리로 제주 종달리" },
        { name: "금백조로가든", region: "동부·성산", address: "성산읍 금백조로 96", dog: "동반 가능(제주관광공사 공식)", baby: "노키즈존 아님", hours: "방문 전 확인", desc: "성산 향토 식당, 반려동물 동반 공식 추천.", mapQuery: "금백조로가든 성산" },
        { name: "주점부리 신양본점", region: "동부·성산", address: "성산읍 신양로 117", dog: "동반 가능(제주관광공사 공식)", baby: "노키즈존 아님", hours: "방문 전 확인", desc: "신양리 반려동물 동반 맛집. 신양해변 인근.", mapQuery: "주점부리 신양" },
        { name: "종달 바베큐", region: "동부·종달리", address: "구좌읍 세종로 353", dog: "텐트형 좌석에서 자유롭게", baby: "개별 텐트형이라 아기 동반 편리", hours: "10:00~23:00", desc: "종달리 숯불 바베큐. 개별 텐트 그물망 좌석.", mapQuery: "종달 바베큐 구좌" },
        { name: "만월당", region: "동부·월정리", address: "구좌읍 월정리 (해변 인근)", dog: "소·중형 가능(대형견 제외) ※확인 권장", baby: "노키즈존 아님", hours: "연중무휴(시간 확인)", desc: "월정리 오션뷰 양식. 리조또·파스타·스테이크.", mapQuery: "만월당 월정리" },
        { name: "나무식탁", region: "서부·대정", address: "대정읍 도원로 214", dog: "동반 가능(제주관광공사 공식)", baby: "노키즈존 아님", hours: "방문 전 확인", desc: "서쪽 반려동물 동반 식당, 공식 추천.", mapQuery: "나무식탁 대정" },
      ],
    },
    {
      key: "walk", name: "반려견 관광·산책·오름·해변", icon: "🏞️", color: "green",
      spots: [
        { name: "지미봉 둘레길", region: "동부·종달리", address: "구좌읍 종달리 산3-1", dog: "동반 가능(목줄), 진드기 주의", baby: "아기띠 권장(비포장)", hours: "상시", desc: "오름 둘레 한 바퀴(약 1시간). 성산일출봉·우도 조망.", mapQuery: "지미봉" },
        { name: "용눈이오름", region: "동부·구좌", address: "구좌읍 종달리 산38", dog: "동반 가능(목줄)", baby: "아기띠(완만, 편도 30분)", hours: "상시(일몰 전 하산)", desc: "분화구 3개의 완만한 오름. 성산·우도 절경.", mapQuery: "용눈이오름" },
        { name: "다랑쉬오름", region: "동부·구좌", address: "구좌읍 세화리 산6", dog: "동반 가능(목줄)", baby: "아기띠 필수(경사 급, 40분)", hours: "상시", desc: "동부 제2 높이(382m). 정상 파노라마 전망.", mapQuery: "다랑쉬오름" },
        { name: "종달리 해안도로", region: "동부·종달리", address: "구좌읍 종달리 해안", dog: "동반 가능(목줄)", baby: "유모차 가능(포장도로)", hours: "상시", desc: "우도·성산이 보이는 절경 해안도로. 산책 최적.", mapQuery: "종달리 해안도로" },
        { name: "함도그비치(함덕)", region: "동부·함덕", address: "조천읍 조함해안로 525", dog: "제주 최초 반려견 입욕구역(여름)/비수기 산책 OK", baby: "해변 산책 가능", hours: "상시(입욕은 여름 운영)", desc: "에메랄드 함덕 바다. 11월엔 한적한 산책.", mapQuery: "함덕해수욕장" },
        { name: "메이즈랜드", region: "동부·구좌", address: "구좌읍 비자림로 2134-47", dog: "동반 불가(확인) — 야외 미로", baby: "36개월 무료, 유모차 가능(평지)", hours: "09:00~18:00(매표~17:00)", desc: "대형 미로 공원. 비수기 한적. ※반려견 동반은 확인 필요.", mapQuery: "메이즈랜드", url: "https://www.mazeland.co.kr/" },
        { name: "신창풍차해안도로", region: "서부·한경", address: "한경면 신창리 1481-23", dog: "동반 가능(목줄·배변봉투)", baby: "유모차 가능(포장)", hours: "상시", desc: "흰 풍차 늘어선 서해안 드라이브·석양 명소.", mapQuery: "신창풍차해안도로" },
        { name: "산양큰엉곶", region: "서부·한경", address: "한경면 연명로 179", dog: "동반 가능(목줄, 맹견 입마개)", baby: "아기띠 권장(숲길)", hours: "상시", desc: "약 3.5km 곶자왈 숲길. 토끼 먹이주기.", mapQuery: "산양큰엉곶" },
      ],
    },
    {
      key: "indoor", name: "아기·실내·우천 대비", icon: "🌧️", color: "blue",
      spots: [
        { name: "해양동물박물관", region: "동부·성산", address: "성산읍 서성일로 689-21", dog: "동반 불가", baby: "36개월 무료, 유모차 대여·기저귀교환대", hours: "09:00~18:00 (수 휴무)", desc: "성산 해양동물 박물관. 비 오는 날 최적.", mapQuery: "제주해양동물박물관 성산" },
        { name: "일출랜드", region: "동부·성산", address: "성산읍 중산간동로 4150-30", dog: "동반 가능(목줄)/동굴은 안고 입장", baby: "유모차 부분 가능(정원)", hours: "08:30~18:00", desc: "천연동굴+꽃정원 테마파크. 반려견 동반 관광지.", mapQuery: "일출랜드 성산", url: "https://ijto.or.kr" },
        { name: "넥슨뮤지엄", region: "제주시", address: "제주시 1100로 3198-8", dog: "동반 불가", baby: "유모차 가능, 체험형 전시", hours: "10:00~18:00 (월 휴무)", desc: "2026.5 리뉴얼 재개관. 게임·컴퓨터 역사 체험.", mapQuery: "넥슨뮤지엄 제주", url: "https://museum.nexon.com" },
        { name: "테디베어뮤지엄 제주", region: "남부·중문", address: "서귀포시 중문관광로110번길 31", dog: "동반 불가", baby: "36개월 무료, 유모차·수유실", hours: "09:00~18:00(입장~17:30)", desc: "테디베어 이색 박물관. 중문 우천 대비 코스.", mapQuery: "테디베어뮤지엄 제주" },
        { name: "제주민속자연사박물관", region: "제주시", address: "제주시 삼성로 40", dog: "동반 불가", baby: "어린이 무료, 유모차 가능", hours: "09:00~18:00 (월 휴관)", desc: "제주 자연·민속·역사. 어른 2,000원, 우천 시 알참.", mapQuery: "제주민속자연사박물관" },
      ],
    },
    {
      key: "exp", name: "체험 (레저·생태)", icon: "🎯", color: "orange",
      spots: [
        { name: "비체올린", region: "서부·한경", address: "한경면 판조로 253-6", dog: "카약 동반 탑승 가능(소형5천·중형7천, 15kg↑ 불가)", baby: "야외, 유모차 부분 가능", hours: "방문 전 확인(노란나비 축제 10~12월)", desc: "레저힐링파크. 카약·미로·곶자왈·토끼 먹이주기.", mapQuery: "비체올린 한경" },
        { name: "9.81파크", region: "서부·애월", address: "애월읍 천덕로 880-24", dog: "실내 동반 패키지(토요일 한정, 예약)", baby: "카트 영아 제한, 동반 입장 가능", hours: "계절별 상이(확인)", desc: "무중력 레이싱 카트. 우천 시도 실내 이용.", mapQuery: "9.81파크 애월", url: "https://www.981park.com" },
        { name: "제주 화조원", region: "서부·애월", address: "애월읍 애원로 804", dog: "정책 불명확 ※확인 권장", baby: "36개월 무료, 새 먹이주기", hours: "매일 09:00~18:00", desc: "희귀 조류 생태 체험관. 새 먹이주기 인기.", mapQuery: "제주 화조원 애월" },
      ],
    },
  ],
};
  ...
  categories: [
    ...
    },
    {
      ...
      places: [
        ...
        { name: "어니스트밀크", address: "성산읍 중산간동로 3147-7", distance: "12km", time: "차량 18분", lat: 33.4504, lng: 126.8720, desc: "목장 카페. 송아지 우유주기 체험. 성산일출봉 조망.", dog: true, baby: true },
      ],
    },
    {
      name: "병원/약국",
      ...
      color: "red",
      places: [
        { name: "서울의원", address: "구좌읍 구좌로 51 (세화리)", distance: "3km", time: "차량 5분", lat: 33.5232, lng: 126.8570, desc: "내과·소아청소년과 등 표방 동네의원. 낮 경증 1차. (방문 전 전화 확인)", dog: false, baby: true },
        { name: "세화약국", address: "구좌읍 세화10길 1", distance: "3km", time: "차량 5분", lat: 33.5250, lng: 126.8620, desc: "공공심야약국(심야 ~23시 운영일 확인). 064-784-8442. 일 휴무.", dog: false, baby: true },
        { name: "동아동물병원", address: "성산읍 서성일로 1241", distance: "20km+", time: "차량 25분", lat: 33.4380, lng: 126.9010, desc: "동부 유일 확인 동물병원(주간 1차). 064-782-1175. 방문 전 전화 확인.", dog: true, baby: false },
        { name: "제주24시숨동물의료센터", address: "제주시 연북로 632", distance: "40km+", time: "차량 45분", lat: 33.4899, lng: 126.5457, desc: "24시 동물병원(365일). 강아지 야간·응급 시. 064-805-8365.", dog: true, baby: false },
      ],
    },
  ],
};

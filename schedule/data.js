...
const EV_GUIDE = {
  ...
  chargers: {
    ...
    mapPoints: [
      ...
      { name: "데스티네이션 하도리", type: "destination", lat: 33.5188, lng: 126.8831, mapQuery: "테슬라 데스티네이션 하도리" },
      { name: "데스티네이션 성산(한도로)", type: "destination", lat: 33.4689, lng: 126.9357, mapQuery: "더클라우드호텔 성산 테슬라" },
